...
from tello_height import FrontEnd as go_to_height 
...
class FrontEnd(object):
    ...
    def __init__(self,tello):
        ...
        self.go_height = go_to_height(self.tello)
    ...
    def run(self):
        ...
        initial_height = self.tello.get_h()

        while (self.tello.get_h()<300):
            ...
            if (key == ord("m")):
                ...
                if(rect.min() != 0):
                    print("Found the shelf to pass from")
                    if(self.tello.get_h()<1.5):
                        return 1,0
                    else:
                        return 1,1
        ...
        self.go_height.run(initial_height)
        return 0,0
