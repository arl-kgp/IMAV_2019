...
class FrontEnd(object):
    ...
    def run(self):
        ...
        while not should_stop:
            ...
            f=self.passFromWindow(trigger,key,mask,dst)
    ...
    def passFromWindow(self,trigger,key,mask,dst):
        frameH,frameW = 20,75
        self.PoseEstimationfrmMask(mask,dst,frameH,frameW)
        self.manualRcControl(key)
    ...
    def PoseEstimationfrmMask(self,mask,frame,frameH,frameW):
        # Contours detection
